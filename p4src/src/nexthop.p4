...
control EcmpGroup13(inout headers_t hdr,
            inout common_metadata_t meta,
            in ingress_intrinsic_metadata_t ig_intr_md,
            in ingress_intrinsic_metadata_from_parser_t ig_intr_from_prsr,
            inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr,
            inout ingress_intrinsic_metadata_for_tm_t  ig_tm_md) {
    Hash<bit<16>>(HashAlgorithm_t.CRC16) selector_hash;
    ActionProfile(ECMP_SELECTION_TABLE_SIZE_V2) pipe13_group_action_profile;
    ActionSelector(pipe13_group_action_profile, selector_hash, SelectorMode_t.FAIR,
                   ECMP_MAX_MEMBERS_PER_GROUP_V2,
                   4) pipe13_group_selector;
    ...
    table ecmp_group_13 {
        ...
        const default_action = NoAction();
        implementation = pipe13_group_selector;
        size = 4;
    }
